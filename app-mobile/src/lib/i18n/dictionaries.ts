...
const hinglish: Dict = {
  ...
  reminders: {
    ...
    upcoming: "Aane wale",
    longPressHint: "Delete karne ke liye card ko dabaye rakho",
    pausedTag: "Plus khatam — paused. Tap karke Plus lo",
    deleteConfirmTitle: "Delete karein?",
  ...
  addReminder: {
    ...
    limitReached: "Free me 5 active reminders — Plus lo unlimited ke liye",
  },
  chat: {
  ...
  settings: {
    ...
    plusSub: "Unlimited reminders, documents + aur bahut kuch",
    groupSaathi: "Saathi",
...
const hi: Dict = {
  ...
  reminders: {
    ...
    upcoming: "आने वाले",
    longPressHint: "डिलीट करने के लिए कार्ड को दबाए रखें",
    pausedTag: "प्लस खत्म — रुका है। टैप करके प्लस लें",
    deleteConfirmTitle: "डिलीट करें?",
  ...
  addReminder: {
    ...
    limitReached: "फ्री में 5 active रिमाइंडर — अनलिमिटेड के लिए प्लस लें",
  },
  chat: {
  ...
  settings: {
    ...
    plusSub: "अनलिमिटेड रिमाइंडर, डॉक्युमेंट + और बहुत कुछ",
    groupSaathi: "साथी",
...
const en: Dict = {
  ...
  reminders: {
    ...
    upcoming: "Upcoming",
    longPressHint: "Press and hold a card to delete",
    pausedTag: "Plus ended — paused. Tap to get Plus",
    deleteConfirmTitle: "Delete?",
  ...
  addReminder: {
    ...
    limitReached: "5 active reminders on Free — get Plus for unlimited",
  },
  chat: {
  ...
  settings: {
    ...
    plusSub: "Unlimited reminders, documents + much more",
    groupSaathi: "Saathi",
    groupPrivacy: "Privacy",
    groupMore: "More",
